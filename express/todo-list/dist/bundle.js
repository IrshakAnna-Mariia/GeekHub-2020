...
const Emitter = __webpack_require__(11);
...
const debug = __webpack_require__(15)("socket.io-client:manager");
...
const globalThis = __webpack_require__(16);
...
const debug = __webpack_require__(17)("engine.io-client:polling");
...
const Emitter = __webpack_require__(11);
const on_1 = __webpack_require__(44);
const debug = __webpack_require__(15)("socket.io-client:socket");
/**
 * Internal events.
...
const debug = __webpack_require__(15)("socket.io-client");
/**
 * Module exports.
 */
...
const debug = __webpack_require__(15)("socket.io-client:url");
/**
 * URL parser.
 *
 * @param uri - url
...
const Emitter = __webpack_require__(11);
const debug = __webpack_require__(17)("engine.io-client:socket");
const parser = __webpack_require__(13);
const parseuri = __webpack_require__(34);
const parseqs = __webpack_require__(24);
...
const debug = __webpack_require__(17)("engine.io-client:polling-xhr");
...
const debug = __webpack_require__(17)("engine.io-client:websocket");
...
socket.on('completed_todo', function (todos) {
  src_store.dispatch(setTodosForAll([todos]));
  src_store.dispatch(setTodos([todos]));
});
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 10:
          ...
          alert("Oh, no... Get data is uncurrently");
    ...
    while (1) {
      switch (_context5.prev = _context5.next) {
        ...
        case 3:
          ...
          _context5.next = 7;
          return fetch("http://localhost:8000/complete", {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json;charset=utf-8'
            },
    ...
    return regenerator_default.a.wrap(function _callee$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            _context6.next = 2;
            return fetch("http://localhost:8000/get");
