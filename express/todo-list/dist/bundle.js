...
const encodePacket = __webpack_require__(72);
const decodePacket = __webpack_require__(73);
...
const Emitter = __webpack_require__(12);
const binary_1 = __webpack_require__(84);
const is_binary_1 = __webpack_require__(43);
const debug = __webpack_require__(85)("socket.io-parser");
/**
 * Protocol version.
 *
 * @public
...
"use strict";
/* WEBPACK VAR INJECTION */(function(global, module) {/* harmony import */ var _ponyfill_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(45);
/* global window */
...
const eio = __webpack_require__(68);
const socket_1 = __webpack_require__(42);
const Emitter = __webpack_require__(12);
const parser = __webpack_require__(25);
const on_1 = __webpack_require__(44);
const Backoff = __webpack_require__(88);
const debug = __webpack_require__(16)("socket.io-client:manager");
...
const XMLHttpRequest = __webpack_require__(37);
const XHR = __webpack_require__(71);
const JSONP = __webpack_require__(77);
...
const hasCORS = __webpack_require__(70);
const globalThis = __webpack_require__(17);
...
const Transport = __webpack_require__(23);
const parseqs = __webpack_require__(24);
const parser = __webpack_require__(14);
const yeast = __webpack_require__(40);

const debug = __webpack_require__(18)("engine.io-client:polling");
...
const Emitter = __webpack_require__(12);
const on_1 = __webpack_require__(44);
const debug = __webpack_require__(16)("socket.io-client:socket");
/**
 * Internal events.
...
const url_1 = __webpack_require__(65);
const manager_1 = __webpack_require__(35);
const socket_1 = __webpack_require__(42);
Object.defineProperty(exports, "Socket", { enumerable: true, get: function () { return socket_1.Socket; } });
const debug = __webpack_require__(16)("socket.io-client");
/**
 * Module exports.
 */
 ...
 * @public
 */
var manager_2 = __webpack_require__(35);
...
*/
var aa=__webpack_require__(0),m=__webpack_require__(30),r=__webpack_require__(51);function y(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}if(!aa)throw Error(y(227));var ba=new Set,ca={};function da(a,b){ea(a,b);ea(a+"Capture",b)}
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.url = void 0;
const parseuri = __webpack_require__(34);
const debug = __webpack_require__(16)("socket.io-client:url");
/**
 * URL parser.
 *
 * @param uri - url
...
const Socket = __webpack_require__(69);
...
module.exports.Transport = __webpack_require__(23);
module.exports.transports = __webpack_require__(36);
...
const transports = __webpack_require__(36);
const Emitter = __webpack_require__(12);
const debug = __webpack_require__(18)("engine.io-client:socket");
const parser = __webpack_require__(14);
const parseuri = __webpack_require__(34);
const parseqs = __webpack_require__(24);
...
const XMLHttpRequest = __webpack_require__(37);
const Polling = __webpack_require__(38);
const Emitter = __webpack_require__(12);
const { pick } = __webpack_require__(41);
const globalThis = __webpack_require__(17);

const debug = __webpack_require__(18)("engine.io-client:polling-xhr");
...
const { PACKET_TYPES } = __webpack_require__(39);
...
const { PACKET_TYPES_REVERSE, ERROR_PACKET } = __webpack_require__(39);

const withNativeArrayBuffer = typeof ArrayBuffer === "function";

let base64decoder;
if (withNativeArrayBuffer) {
  base64decoder = __webpack_require__(74);
}
...
/* WEBPACK VAR INJECTION */(function(Buffer) {const Transport = __webpack_require__(23);
const parser = __webpack_require__(14);
const parseqs = __webpack_require__(24);
const yeast = __webpack_require__(40);
const { pick } = __webpack_require__(41);
...
const debug = __webpack_require__(18)("engine.io-client:websocket");
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "store", function() { return /* binding */ src_store; });
...
var css_base = __webpack_require__(57);

// EXTERNAL MODULE: ./css/index.css
var css = __webpack_require__(59);
...
(function () {
  ...
  function Learn(learnJSON, config) {
    ...
    if (typeof_default()(learnJSON) !== 'object') {
      try {
  ...
  Learn.prototype.append = function (opts) {
    ...
    if (opts && opts.backend) {
      ...
      var sourceLink = sourceLinks.lastElementChild; // Correct link path
...
var IS_COMPLETED = 'IS_COMPLETED';
var IS_EDIT = 'IS_EDIT';
var SET_TODOS_FILTER = 'filter/setTodos';
var SET_TODOS = 'setTodos';
var REWRITE_TODO = 'rewriteTodo';
var DELETE_WRITTEN_TODO = 'deleteWrittenTodo';
function writeTodo(text, newText) {
  return {
    type: REWRITE_TODO,
    text: text,
    newText: newText
...
function removeWrittenTodo(text) {
  return {
    type: DELETE_WRITTEN_TODO,
    text: text
  };
}
...
function isEditAllTodos(text, newText) {
  return {
    type: IS_EDIT,
    text: text,
    newText: newText
...
function setTodosForAll(payload) {
  return {
    type: SET_TODOS,
    payload: payload
  };
}
function counterCompletedTodo(payload) {
  return {
    type: "filter/count",
    payload: payload
  };
}
function countAddTodo() {
  return {
    type: "filter/countAddTodo"
  };
}
function countMinesTodo() {
  return {
    type: "filter/countMinesTodo"
  };
}
function actions_forCompleteTodo(payload) {
  return {
    type: "filter/forCompleteTodo",
    payload: payload
  };
}
function actions_forRemoveTodo(payload) {
  return {
    type: "filter/forRemoveTodo",
    payload: payload
  };
}
function setCurrentTodo(payload) {
  return {
    type: "filter/setCurrentTodo",
    payload: payload
  };
}
function actions_isEdit(payload) {
  return {
    type: "filter/isEdit",
    payload: payload
  };
...
var redux_toolkit_esm_createDraftSafeSelector = function createDraftSafeSelector() {
...
function createSelectorsFactory() {
  function getSelectors(selectState) {
    ...
    var selectAll = redux_toolkit_esm_createDraftSafeSelector(selectIds, selectEntities, function (ids, entities) {
    ...
    var selectTotal = redux_toolkit_esm_createDraftSafeSelector(selectIds, function (ids) {
      return ids.length;
    });
    ...
    if (!selectState) {
      return {
        ...
        selectById: redux_toolkit_esm_createDraftSafeSelector(selectEntities, selectId, selectById)
      };
    }

    var selectGlobalizedEntities = redux_toolkit_esm_createDraftSafeSelector(selectState, selectEntities);
    return {
      selectIds: redux_toolkit_esm_createDraftSafeSelector(selectState, selectIds),
      selectEntities: selectGlobalizedEntities,
      selectAll: redux_toolkit_esm_createDraftSafeSelector(selectState, selectAll),
      selectTotal: redux_toolkit_esm_createDraftSafeSelector(selectState, selectTotal),
      selectById: redux_toolkit_esm_createDraftSafeSelector(selectGlobalizedEntities, selectId, selectById)
    };
  }
...
// CONCATENATED MODULE: ./src/store/socket.js



var socket = build_default()();
socket.on('add_todo', function (todos) {
  src_store.dispatch(setTodosForAll([]));
  src_store.dispatch(setTodos([]));
});
socket.on('remove_todo', function (todos) {
  src_store.dispatch(setTodosForAll([]));
  src_store.dispatch(setTodos([]));
});
socket.on('completed_todo', function (todos) {
  src_store.dispatch(setTodosForAll([]));
  src_store.dispatch(setTodos([]));
});
socket.on('write_todo', function (todos, addTodo_value, lastTodo_value) {
  if (addTodo_value === '') {
    src_store.dispatch(removeWrittenTodo(lastTodo_value));
  } else {
    src_store.dispatch(writeTodo(lastTodo_value, addTodo_value));
  }
});
/* harmony default export */ var store_socket = (socket);
...
var filterSlice = createSlice({
  ...
  reducers: {
    setTodos: function setTodos(state, action) {
      set_Todos(state, action.payload);
      var count = 0;
      action.payload.map(function (cell) {
    ...
    forCompleteTodo: function forCompleteTodo(state, action) {
      var currentIndex;
      action.payload.allTodo.map(function (cell, index) {
        if (cell.text === action.payload.currentTodo.text) {
          currentIndex = index;
        }
      });
      var actionArray = [].concat(toConsumableArray_default()(action.payload.allTodo.slice(0, currentIndex)), [Object.assign({}, action.payload.allTodo[currentIndex], {
        complete: !action.payload.allTodo.complete
      })], toConsumableArray_default()(action.payload.allTodo.slice(currentIndex + 1)));
      set_Todos(state, actionArray);
    },
    forRemoveTodo: function forRemoveTodo(state, action) {
      var currentIndex;
      action.payload.allTodo.map(function (cell, index) {
        if (cell.text === action.payload.currentTodo.text) {
          currentIndex = index;
      ...
      var actionArray = [].concat(toConsumableArray_default()(action.payload.allTodo.slice(0, currentIndex)), toConsumableArray_default()(action.payload.allTodo.slice(currentIndex + 1)));
      set_Todos(state, actionArray);
    },
    countAddTodo: function countAddTodo(state) {
      state.counter = state.counter + 1;
    },
    countMinesTodo: function countMinesTodo(state) {
      state.counter = state.counter - 1;
    },
    count: function count(state, action) {
      var count = 0;
      action.payload.map(function (cell) {
        if (cell.complete === false) {
          count = count + 1;
    ...
    setCurrentTodo: function setCurrentTodo(state, action) {
      state.currentTodo = [action.payload];
    },
    isEdit: function isEdit(state, action) {
      function setNewTodoText(currentState, currentIndexEdit) {
        return [].concat(toConsumableArray_default()(currentState.slice(0, currentIndexEdit)), [Object.assign({}, currentState[currentIndexEdit], {
          text: action.payload.newText
        })], toConsumableArray_default()(currentState.slice(currentIndexEdit + 1)));
      }

      state.activeTodos.map(function (cell, index) {
        if (cell.text === action.payload.text) {
          state.activeTodos = setNewTodoText(state.activeTodos, index);
        }
      });
      state.completedTodos.map(function (cell, index) {
        if (cell.text === action.payload.text) {
          state.completedTodos = setNewTodoText(state.completedTodos, index);
        }
      });
      state.currentTodo.map(function (cell, index) {
        if (cell.text === action.payload.text) {
...
function todoList() {
  ...
  switch (action.type) {
    case SET_TODOS:
      return toConsumableArray_default()(action.payload);

    case ADD_TODO:
      return [].concat(toConsumableArray_default()(state), [{
        text: action.text,
        complete: false
      }]);

    case REMOVE_TODO:
      var currentIndexRemove;
      state.map(function (cell, index) {
        if (cell.text === action.text) {
          currentIndexRemove = index;
        }
      });
      return [].concat(toConsumableArray_default()(state.slice(0, currentIndexRemove)), toConsumableArray_default()(state.slice(currentIndexRemove + 1)));
    ...
    case IS_COMPLETED:
      ...
      return [].concat(toConsumableArray_default()(state.slice(0, currentIndex)), [Object.assign({}, state[currentIndex], {
        complete: !action.complete
      })], toConsumableArray_default()(state.slice(currentIndex + 1)));

    case IS_EDIT:
      var currentIndexEdit;
      state.map(function (cell, index) {
        if (cell.text === action.text) {
          currentIndexEdit = index;
        }
      });
      return [].concat(toConsumableArray_default()(state.slice(0, currentIndexEdit)), [Object.assign({}, state[currentIndexEdit], {
        text: action.newText
      })], toConsumableArray_default()(state.slice(currentIndexEdit + 1)));

    case REWRITE_TODO:
      var currentIndexRemoveWritten;
      state.map(function (cell, index) {
        if (cell.text === action.text) {
          currentIndexRemoveWritten = index;
        }
      });

      var newArrayTodos = toConsumableArray_default()(state);

      if (currentIndexRemoveWritten) {
        newArrayTodos = [].concat(toConsumableArray_default()(state.slice(0, currentIndexRemoveWritten)), toConsumableArray_default()(state.slice(currentIndexRemoveWritten + 1)));
      }

      return [].concat(toConsumableArray_default()(newArrayTodos), [{
        text: action.newText,
        complete: false
      }]);

    case DELETE_WRITTEN_TODO:
      var currentIndexDelete;
      state.map(function (cell, index) {
        if (cell.text === action.text) {
      ...
      if (currentIndexDelete) {
        return [].concat(toConsumableArray_default()(state.slice(0, currentIndexDelete)), toConsumableArray_default()(state.slice(currentIndexDelete + 1)));
      }
...
var set_Todos = function set_Todos(state, array) {
  var arrayActiveFinally = [];
  var arrayActive = array.map(function (cell) {
    if (cell.complete === false) {
      return cell;
    }
  });
  arrayActive.map(function (cell) {
    if (!(cell === undefined)) {
      arrayActiveFinally.push(cell);
    }
  });
  state.activeTodos = [].concat(arrayActiveFinally);
  var arrayCompleteFinally = [];
  var arrayComplete = array.map(function (cell) {
    if (cell.complete === true) {
      return cell;
    }
  });
  arrayComplete.map(function (cell) {
    if (!(cell === undefined)) {
      arrayCompleteFinally.push(cell);
    }
  });
  state.completedTodos = [].concat(arrayCompleteFinally);
};

var rootReducers = combineReducers({
  toolkit: filterSlice.reducer
});
var todoListApp = combineReducers({
  rootReducers: rootReducers,
  todoList: todoList
});
/* harmony default export */ var reducers = (todoListApp);
var _filterSlice$actions = filterSlice.actions,
    addTodos = _filterSlice$actions.addTodos,
    reducers_isCompleted = _filterSlice$actions.isCompleted,
    reducers_removeTodo = _filterSlice$actions.removeTodo,
    reducers_completed = _filterSlice$actions.completed,
    active = _filterSlice$actions.active,
    reducers_all = _filterSlice$actions.all,
    count = _filterSlice$actions.count;
...
var Header_Header = /*#__PURE__*/function (_Component) {
  ...
  function Header() {
    ...
    defineProperty_default()(assertThisInitialized_default()(_this), "onChange", function (e) {
      if (e.key === 'Backspace') {
        var newValue = Header_input.value.slice(0, Header_input.value.length - 1);
        store_socket.emit('write_todo', [].concat(toConsumableArray_default()(_this.props.todos), [{
          text: Header_input.value + e.key,
          complete: false
        }]), newValue, Header_input.value);
      } else if (e.key === 'Enter') {
        //this.props.dispatch(removeWrittenTodo(input.value))
        _this.props.dispatch(addTodo(Header_input.value));

        _this.props.dispatch(countAddTodo());

        _this.props.dispatch(setTodos([].concat(toConsumableArray_default()(_this.props.todos), [{
          text: Header_input.value,
          complete: false
        }])));
        ...
        store_socket.emit('write_todo', [].concat(toConsumableArray_default()(_this.props.todos), [{
          text: Header_input.value + e.key,
          complete: false
        }]), Header_input.value + e.key, Header_input.value);
      }
    });

    defineProperty_default()(assertThisInitialized_default()(_this), "inputHTML", function (node) {
      return Header_input = node;
    });
  ...
  createClass_default()(Header, [{
    ...
    value: function render() {
      return /*#__PURE__*/react_default.a.createElement("header", {
        className: "header"
      }, /*#__PURE__*/react_default.a.createElement("h1", null, "todos"), /*#__PURE__*/react_default.a.createElement("input", {
        className: "new-todo",
...
Header_Header = connect_connect()(Header_Header);
...
var Footer_Footer = /*#__PURE__*/function (_Component) {
  ...
  function Footer() {
    ...
    defineProperty_default()(assertThisInitialized_default()(_this), "onClickClear", function () {
      var finallyArray = [];

      var arrayCompleted = _this.props.todos.map(function (cell) {
        if (cell.complete === true) {
          return cell;
        }
      ...
      arrayCompleted.reverse().map(function (cell) {
        if (!(cell === undefined)) {
          _this.props.dispatch(removeTodo(cell.text));
        }
      });

      _this.props.dispatch(setTodos(finallyArray));

      _this.props.dispatch(counterCompletedTodo(_this.props.todos));
    });
  ...
  createClass_default()(Footer, [{
    ...
    value: function render() {
      ...
      }, /*#__PURE__*/react_default.a.createElement("strong", null, this.props.countTodos), "item left"), /*#__PURE__*/react_default.a.createElement("ul", {
        className: "filters"
      }, /*#__PURE__*/react_default.a.createElement("li", null, /*#__PURE__*/react_default.a.createElement(Link, {
        to: "/",
        className: "selected"
      }, "All")), /*#__PURE__*/react_default.a.createElement("li", null, /*#__PURE__*/react_default.a.createElement(Link, {
        to: "/active"
      }, "Active")), /*#__PURE__*/react_default.a.createElement("li", null, /*#__PURE__*/react_default.a.createElement(Link, {
        to: "/completed"
      }, "Completed"))), /*#__PURE__*/react_default.a.createElement("button", {
...
Footer_Footer = connect_connect()(Footer_Footer);
// EXTERNAL MODULE: ./node_modules/@babel/runtime/helpers/extends.js
var helpers_extends = __webpack_require__(47);
var extends_default = /*#__PURE__*/__webpack_require__.n(helpers_extends);

// CONCATENATED MODULE: ./src/components/ViewTextTodo.js
...
function ViewTextTodo_createSuper(Derived) { var hasNativeReflectConstruct = ViewTextTodo_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = getPrototypeOf_default()(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = getPrototypeOf_default()(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return possibleConstructorReturn_default()(this, result); }; }

function ViewTextTodo_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Date.prototype.toString.call(Reflect.construct(Date, [], function () {})); return true; } catch (e) { return false; } }




var ViewTextTodo_input;

var ViewTextTodo_ViewTextTodo = /*#__PURE__*/function (_Component) {
  inherits_default()(ViewTextTodo, _Component);

  var _super = ViewTextTodo_createSuper(ViewTextTodo);

  function ViewTextTodo() {
    var _this;

    classCallCheck_default()(this, ViewTextTodo);
    ...
    defineProperty_default()(assertThisInitialized_default()(_this), "inputHTML", function (node) {
      return ViewTextTodo_input = node;
    });

    defineProperty_default()(assertThisInitialized_default()(_this), "onEnter", function (e) {
      if (e.key === 'Enter') {
        _this.props.dispatch(isEditAllTodos(_this.props.text, ViewTextTodo_input.value));

        _this.props.dispatch(actions_isEdit({
          text: _this.props.text,
          newText: ViewTextTodo_input.value
        }));
      }
    });
  ...
  createClass_default()(ViewTextTodo, [{
    key: "render",
    value: function render() {
      if (this.props.edit === undefined) {
        return /*#__PURE__*/react_default.a.createElement("label", null, this.props.text);
      } else return /*#__PURE__*/react_default.a.createElement("input", {
        className: "new-todo",
...
ViewTextTodo_ViewTextTodo = connect_connect()(ViewTextTodo_ViewTextTodo);
...
function Todo_createSuper(Derived) { var hasNativeReflectConstruct = Todo_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = getPrototypeOf_default()(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = getPrototypeOf_default()(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return possibleConstructorReturn_default()(this, result); }; }

function Todo_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Date.prototype.toString.call(Reflect.construct(Date, [], function () {})); return true; } catch (e) { return false; } }
...
var Todo_Todo = /*#__PURE__*/function (_Component) {
  inherits_default()(Todo, _Component);

  var _super = Todo_createSuper(Todo);
  ...
  function Todo() {
    ...
    defineProperty_default()(assertThisInitialized_default()(_this), "onClickComplete", function () {
      return _this.props.onClickCompleted(_this.props.index);
    });

    defineProperty_default()(assertThisInitialized_default()(_this), "onClickRemove", function () {
      return _this.props.onClickRemove(_this.props.index);
    });

    defineProperty_default()(assertThisInitialized_default()(_this), "onClickView", function () {
      return _this.props.onClickView(_this.props.index);
    });
  ...
  createClass_default()(Todo, [{
    key: "render",
    value: function render() {
      return /*#__PURE__*/react_default.a.createElement("div", null, /*#__PURE__*/react_default.a.createElement("li", {
        className: this.props.complete ? "completed" : "view"
      ...
      }), /*#__PURE__*/react_default.a.createElement(ViewTextTodo_ViewTextTodo, {
      ...
      }, "View Todo"), /*#__PURE__*/react_default.a.createElement(Link, {
        to: '/todo/:' + this.props.index + '/edit',
        className: "editTodo",
        onClick: this.onClickView
      }, "Edit Todo")), /*#__PURE__*/react_default.a.createElement("input", {
        className: "edit",
...
Todo_Todo = connect_connect()(Todo_Todo);
...
function TodoList_createSuper(Derived) { var hasNativeReflectConstruct = TodoList_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = getPrototypeOf_default()(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = getPrototypeOf_default()(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return possibleConstructorReturn_default()(this, result); }; }

function TodoList_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Date.prototype.toString.call(Reflect.construct(Date, [], function () {})); return true; } catch (e) { return false; } }
...
var TodoList_TodoList = /*#__PURE__*/function (_Component) {
  inherits_default()(TodoList, _Component);

  var _super = TodoList_createSuper(TodoList);
  ...
  function TodoList() {
    ...
    defineProperty_default()(assertThisInitialized_default()(_this), "onClickCompleted", function (index) {
      _this.props.dispatch(isCompleted(_this.props.todos[index].text));

      if (!(_this.props.todos[index].complete === true)) {
        _this.props.dispatch(countMinesTodo());
      }

      _this.props.dispatch(actions_forCompleteTodo({
        allTodo: _this.props.allTodos,
        currentTodo: _this.props.todos[index]
      }));
    });

    defineProperty_default()(assertThisInitialized_default()(_this), "onClickRemove", function (index) {
      _this.props.dispatch(removeTodo(_this.props.todos[index].text));

      if (_this.props.todos[index].complete === false) {
        _this.props.dispatch(countMinesTodo());
      }

      _this.props.dispatch(actions_forRemoveTodo({
        allTodo: _this.props.allTodos,
        currentTodo: _this.props.todos[index]
      }));
    });

    defineProperty_default()(assertThisInitialized_default()(_this), "onClickView", function (index) {
      _this.props.dispatch(setCurrentTodo(_this.props.todos[index]));
    });
  ...
  createClass_default()(TodoList, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/react_default.a.createElement("section", {
        ...
        htmlFor: "toggle-all"
      }, "Mark all as complete"), /*#__PURE__*/react_default.a.createElement("ul", {
        className: "todo-list"
      }, this.props.todos.map(function (cell, index) {
        return /*#__PURE__*/react_default.a.createElement(Todo_Todo, extends_default()({
          key: index,
          index: index,
          onClickCompleted: _this2.onClickCompleted,
          onClickRemove: _this2.onClickRemove,
          onClickView: _this2.onClickView,
...
TodoList_TodoList = connect_connect()(TodoList_TodoList);
...
var app_App = /*#__PURE__*/function (_Component) {
  ...
  createClass_default()(App, [{
    ...
    value: function render() {
      return /*#__PURE__*/react_default.a.createElement("section", {
        className: "todoapp"
      }, /*#__PURE__*/react_default.a.createElement(react_router_dom_BrowserRouter, null, /*#__PURE__*/react_default.a.createElement(Header_Header, {
        ...
        exact: true,
        path: "/"
      }, /*#__PURE__*/react_default.a.createElement(TodoList_TodoList, {
        todos: this.props.todoList,
        ...
        allTodos: this.props.todoList,
        edit: true
      }))), /*#__PURE__*/react_default.a.createElement(Footer_Footer, {
        todos: this.props.todoList,
...
var redux_saga_is_esm_observable = function observable(ob) {
...
var io_6de156f3_detach = function detach(eff) {
  ...
  return io_6de156f3_makeEffect(FORK, _extends({}, eff.payload, {
    detached: true
  }));
};
...
function throttle(delayLength, pattern, worker) {
  ...
  var yTake = function yTake() {
    return {
      ...
      value: io_6de156f3_take(channel)
    };
  };
...
function debounceHelper(delayLength, patternOrChannel, worker) {
  ...
  var yRace = {
    ...
    value: race({
      action: io_6de156f3_take(patternOrChannel),
...
var Error_Error = /*#__PURE__*/function (_Component) {
  inherits_default()(Error, _Component);

  var _super = Error_createSuper(Error);
  ...
  createClass_default()(Error, [{
    key: "render",
    value: function render() {
      return /*#__PURE__*/react_default.a.createElement("div", null, /*#__PURE__*/react_default.a.createElement("section", {
        className: "todoapp"
      }, /*#__PURE__*/react_default.a.createElement("header", {
        className: "header"
      }, /*#__PURE__*/react_default.a.createElement("h1", null, "todos"))), /*#__PURE__*/react_default.a.createElement("div", {
        className: "error"
      }, /*#__PURE__*/react_default.a.createElement("h1", null, "Something is not working, please reload the page")), /*#__PURE__*/react_default.a.createElement("footer", {
        className: "info"
      }, /*#__PURE__*/react_default.a.createElement("p", null, "Double-click to edit a todo"), /*#__PURE__*/react_default.a.createElement("p", null, "Template by ", /*#__PURE__*/react_default.a.createElement("a", {
        href: "http://sindresorhus.com"
      }, "Sindre Sorhus")), /*#__PURE__*/react_default.a.createElement("p", null, "Created by ", /*#__PURE__*/react_default.a.createElement("a", {
        href: "http://todomvc.com"
      }, "you")), /*#__PURE__*/react_default.a.createElement("p", null, "Part of ", /*#__PURE__*/react_default.a.createElement("a", {
        href: "http://todomvc.com"
      }, "TodoMVC"))));
    }
  }]);
...
var _marked = /*#__PURE__*/regenerator_default.a.mark(watchSaga),
    _marked2 = /*#__PURE__*/regenerator_default.a.mark(getResponse),
    _marked3 = /*#__PURE__*/regenerator_default.a.mark(postResponse),
    _marked4 = /*#__PURE__*/regenerator_default.a.mark(postResponseRemove),
    _marked5 = /*#__PURE__*/regenerator_default.a.mark(postResponseComplete);
...
function watchSaga() {
  return regenerator_default.a.wrap(function watchSaga$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return takeLeading$1([SET_TODOS, SET_TODOS_FILTER], getResponse);

        case 2:
          _context.next = 4;
          return takeLatest$1([ADD_TODO], postResponse);

        case 4:
          _context.next = 6;
          return takeLatest$1([REMOVE_TODO], postResponseRemove);

        case 6:
          _context.next = 8;
          return takeLatest$1([IS_COMPLETED], postResponseComplete);
...
function getResponse() {
  var payload;
  return regenerator_default.a.wrap(function getResponse$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return call(fetchTodos);

        case 3:
          payload = _context2.sent;
          _context2.next = 6;
          return io_6de156f3_put({
            type: SET_TODOS,
            payload: payload
          });
        ...
        case 10:
          ...
          react_dom_default.a.render( /*#__PURE__*/react_default.a.createElement(Error_Error, null), document.body);
...
function postResponse() {
  var todos;
  return regenerator_default.a.wrap(function postResponse$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return io_6de156f3_select(function (state) {
            return state.todoList;
          });

        case 3:
          todos = _context3.sent;
          store_socket.emit('add_todo', todos);
          _context3.next = 7;
          return fetch("/add", {
            method: 'POST',
            headers: {
...
function postResponseRemove() {
  var todos;
  return regenerator_default.a.wrap(function postResponseRemove$(_context4) {
    while (1) {
      switch (_context4.prev = _context4.next) {
        ...
        case 3:
          ...
          store_socket.emit('remove_todo', todos);
          _context4.next = 7;
...
function postResponseComplete() {
  var todos;
  return regenerator_default.a.wrap(function postResponseComplete$(_context5) {
    while (1) {
      switch (_context5.prev = _context5.next) {
        ...
        case 3:
          ...
          store_socket.emit('completed_todo', todos);
          _context5.next = 7;
...
function _fetchTodos() {
  _fetchTodos = asyncToGenerator_default()( /*#__PURE__*/regenerator_default.a.mark(function _callee() {
    var response;
...
var src_saga = redux_saga_core_npm_proxy_esm();
var src_store = createStore(reducers, applyMiddleware(redux_thunk_es, src_saga));
src_saga.run(watchSaga);
src_render();
src_store.subscribe(src_render);
src_store.dispatch(setTodosForAll([]));
src_store.dispatch(setTodos([]));
...
function src_render() {
  react_dom_default.a.render( /*#__PURE__*/react_default.a.createElement(components_Provider, {
    store: src_store
  }, /*#__PURE__*/react_default.a.createElement(app_App, {
    todoList: src_store.getState().todoList,
    todoListActive: src_store.getState().rootReducers.toolkit.activeTodos,
    todoListCompleted: src_store.getState().rootReducers.toolkit.completedTodos,
    todoListCurrent: src_store.getState().rootReducers.toolkit.currentTodo,
    count: src_store.getState().rootReducers.toolkit.counter
